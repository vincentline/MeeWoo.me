...
var import_tinypng_lib_wasm = require("tinypng-lib-wasm");
var import_compressorjs = __toESM(require("compressorjs"), 1);
...
var TinyPNG = class {
  ...
  compressPngImage(imageData, options) {
    return __async(this, null, function* () {
      ...
      const imagequant = new import_tinypng_lib_wasm.ImagequantImage(uint8Array, imageDataWidth, imageDataHeight, 0);
      const imagequantnstance = new import_tinypng_lib_wasm.Imagequant();
